...
<!-- 캠핑장 상세내역 start -->		
        <div id="detail_information_maincontent">
            ...
            <div id="detail_information_image">
                <h1>위치</h1>
				<div class="box_border" id="map"></div>
				<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=1ecf3cd39df7ec731e60410b5515f60c&libraries=services"></script>
				<script>
				...
				var address = '<c:out value="${ requestScope.spotDTO.addr1 + requestScope.spotDTO.addr2 }"/>';
				// 주소로 좌표를 검색합니다
				    ...
				    // 정상적으로 검색이 완료됐으면 
				     if (status === daum.maps.services.Status.OK) {
				        ...
				        var infowindow = new daum.maps.InfoWindow({
				            content: '<div style="width:150px;text-align:center;padding:6px 0;">SHAREHOUSE</div>'
				        });
				...
				<p>
					${ vo.address1} ${ vo.address2 } 
					<a id="load" href="http://map.daum.net/link/to/카카오판교오피스,37.402056,127.108212">길찾기</a>
				</p>
            </div>
			<!--캠핑장 지도 end -->
