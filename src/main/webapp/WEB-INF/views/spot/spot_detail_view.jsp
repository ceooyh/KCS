	...
	<section>
		...
		<div id="main_content_container">
			...
			<div id="maint_content_info">
				...
				<div class="detail_content_div">
					<span id="resevation_btn"><a href="bookView.do?contentId=${requestScope.spotDTO.contentId }&facltNm=${requestScope.spotDTO.facltNm}&bizrno=${requestScope.spotDTO.bizrno}&firstImageUrl=${requestScope.spotDTO.firstImageUrl}">예약하기</a></span> <span
